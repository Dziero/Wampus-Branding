    ...
    return (
        <section className="2xl:min-h-[calc(100vh-59px)] xl:min-h-[calc(100vh-47px)] lg:min-h-[calc(100vh-38px)] md:min-h-[calc(100vh-30px)] min-h-[calc(100vh-24px)] pb-16" id="projects">
            <div className="text-center pt-2">
                <span className="font-thin tracking-tight text-center cursor-default 2xl:text-xl xl:text-lg lg:text-base md:text-sm text-xs px-3 text-white">{ t('Below') }</span>
            </div>
